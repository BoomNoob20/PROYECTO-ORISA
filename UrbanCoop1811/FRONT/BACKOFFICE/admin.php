    ...
    try {
        switch ($_POST['action']) {
            ...
            case 'create_meeting':
                ...
                $lugar = $_POST['lugar'];
                $stmt = $pdo->prepare("INSERT INTO reuniones (titulo, descripcion, fecha_hora, lugar) VALUES (?, ?, ?, ?)");
...
if ($pdo) {
    try {
        ...
        $upcoming_meetings = $pdo->query("SELECT * FROM reuniones WHERE fecha_hora >= NOW() AND estado = 'programada' ORDER BY fecha_hora ASC LIMIT 10")->fetchAll();
...
<body>
                            ...
                            <div class="meeting-card">
                                ...
                                <div class="meeting-info">
                                    <div class="meeting-info-item">
                                        <i class="fas fa-calendar"></i>
                                        <span><?= formatDate($meeting['fecha_hora']) ?></span>
                                    </div>
                    ...
                    <form id="meeting-form" style="background: white; padding: 30px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); margin-bottom: 30px;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-input" name="fecha_hora" required>
                            </div>
    ...
    <script>
        ...
        function goToProfile() {
            ...
            window.location.href = '../perfil.php?user_id=' + JSON.parse(userData).id + "&verify=" + encodeURIComponent(JSON.parse(userData).verify);
        }
