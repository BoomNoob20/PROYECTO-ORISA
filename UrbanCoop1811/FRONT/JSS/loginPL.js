...
document.getElementById('loginForm').addEventListener('submit', function(e) {
    ...
    fetch('http://localhost/UrbanCoop1811/APIS/API_Usuarios.php?action=login', {
        method: 'POST',
        headers: {
        ...
        if (data.success) {
            ...
            setTimeout(() => {
                if (data.user.is_admin == 1) {
                    ...
                    window.location.href = 'perfil.php?user_id=' + data.user.id + "&verify=" + encodeURIComponent(data.user.verify);
                }
            }, 1500);
